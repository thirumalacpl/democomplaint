$(document).on('pageshow', '#insert_details', function(){ 
...
//alert(pat_name+'pat_name');
  ...
  */
  ...
  /*if(moblen != 10){
    ...
    $.mobile.changePage($('#insert_details'), { transition: "none", changeHash: true, reverse: false });
  }*/
...
var formData = $("#callAjaxForm").serialize();
  ...
  $.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/slim/slim-heart-mergedb/user_input.php?firstname="+userfname+"&lastname="+userlname,
  data: formData,
  success: onSuccessfg,
  async: 'true',
  crossDomain: true,
